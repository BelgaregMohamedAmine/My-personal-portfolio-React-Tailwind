  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">
      <div className="text-center">
        ...
        >
          {/* Cartoon BI Analyst Character */}
          <div className="w-64 h-64 relative">
            {/* Head with Glasses and Dashboard Hat */}
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-40 h-40 bg-orange-200 rounded-full border-4 border-gray-700">
              ...
              {/* Dashboard Hat */}
              <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-32 h-8 bg-blue-500 rounded-t-lg">
                {/* Mini Charts */}
                <div className="absolute left-2 top-1 w-4 h-4 bg-green-400 rounded-sm" />
                <div className="absolute right-2 top-1 w-4 h-4 bg-red-400 rounded-sm" />
              </div>
