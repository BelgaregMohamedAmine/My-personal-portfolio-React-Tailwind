...
const FullscreenModal = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div 
      className="fixed inset-0 bg-black/95 z-50 backdrop-blur-sm flex items-center justify-center"
      onClick={onClose}
    >
      <button
        onClick={onClose}
        className="absolute top-6 right-6 text-white p-3 hover:bg-white/10 rounded-full z-50 transition-all duration-300 hover:rotate-90"
      >
        <X className="w-6 h-6" />
      </button>
        ...
        >
          ...
          <button
            ...
            className="absolute top-4 right-4 backdrop-blur-md bg-black/30 p-2 
              ...
              hover:bg-black/50 opacity-0 group-hover:opacity-100"
          >
