...
import { 
  ...
  Clock, Briefcase, Award, Code, Download, Maximize, BookOpen
} from 'lucide-react';
...
const ProjectDetails = () => {
  ...
  const [showFullPDF, setShowFullPDF] = useState(false); // Pour gérer l'affichage complet du PDF
                  ...
                  <div className="prose dark:prose-invert max-w-none">
                    ...
                    {project.documents && project.documents.length > 0 && (
                      <div className="mt-6 relative">
                        ...
                        {/* PDF intégré */}
                        <iframe
                          src={project.documents[0].url}
                          title={project.documents[0].title}
                          className={`w-full ${showFullPDF ? 'h-[800px]' : 'h-96'} rounded-lg shadow-lg mt-10`}
                        />
                        ...
                        {!showFullPDF && (
                          <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors mt-4"
                          >
